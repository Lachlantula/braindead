  ...
  methods: {
    ...
    translate() {
      ...
      for (let line = 0; line < pseudoLines.length; line += 1) {
        ...
        // Printing
        if (keyword === 'say' || keyword === 'write' || keyword === 'output' || keyword === 'print') {
        ...
        // Loops
        } else if (keyword === 'loop' || keyword === 'repeat') {
        ...
        // Ending Loop(s)
        } else if (keyword === 'end' || keyword === 'stop' || keyword === 'done' || keyword === 'break') {
